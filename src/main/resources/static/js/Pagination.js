(function ($) {
    ...
    $.fn.Pagination = function (options) {
        ...
        options.prev = options.prev || '<i class="fa fa-angle-left"></i>';   // 自定义上一页按钮
        options.next = options.next || '<i class="fa fa-angle-right"></i>';   // 自定义下一页按钮
        options.first = options.first || '<i class="fa fa-angle-double-left"></i>';   // 自定义首页按钮
        options.last = options.last || '<i class="fa fa-angle-double-right"></i>';     // 自定义尾页按钮
        ...
        do {
            ...
            pageListHtml += '<li class="page-list page-item'+Selected+'"><a class="page-link" href="#">'+i+'</a></li>';
            i ++;
            // 判断显示页数
            // i 小于 当前页 + 页码浮动量
        ...
        let html = '<nav aria-label="Page navigation example">' +
            '<ul class="pagination">' +
            '<li class="page-item"><a href="#" class="pager-item page-link" aria-label="first"  title="回到首页"><span aria-hidden="true">'+ options.first +'</span></a></li>' +
            '<li class="page-item"><a href="#" class="pager-item page-link" aria-label="prev" title="上一页"><span aria-hidden="true">'+ options.prev +'</span></a></li>' +
            pageListHtml +
            '<li class="page-item"><a href="#" class="pager-item page-link" aria-label="next" class="下一页"><span aria-hidden="true">'+ options.next +'</span></a></li>' +
            '<li class="page-item"><a href="#" class="pager-item page-link" aria-label="last" title="前往尾页"><span aria-hidden="true">'+ options.last +'</span></a></li>' +
            '</ul></nav>';
